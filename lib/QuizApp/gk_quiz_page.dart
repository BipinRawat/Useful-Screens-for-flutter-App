...
class gkloadjson extends StatelessWidget {
  String gktypename;
  gkloadjson(this.gktypename);
  String assettoload;

  setasset() {
    if (gktypename == "World") {
      assettoload = "assets/world_quiz.json";
    } else if (gktypename == "India") {
      assettoload = "assets/india_quiz.json";
    } else {
      assettoload = "assets/uk_quiz.json";
    }
  }
